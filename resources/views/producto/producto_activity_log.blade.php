...
<div class="panel panel-primary">
    <div class="panel-heading">Productos Log</div>
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <form action="{{route('activity/log/producto')}}" method="GET" class="navbar-form" role="search">
                ...
                <a href="/activity/log/producto" class="btn btn-sm btn-success">ACTUALIZAR</a>
            </form>
			<div class="panel-heading">
            
				<h3 class="panel-title">Tabla de Logs - Productos</h3>
			</div>
